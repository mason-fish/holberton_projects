...
/*
* check_b() recieves a string vector,
...
*/
int check_b(int ac, char **cmd, char **env)
{
        int i;
        ...
        for (i = 0; builtins_v[i] != NULL; i++) {
                if ((str_cmp(cmd[0], builtins_v[i])) == 0) {
...
char **check_b_e(int ac, char **cmd, char **env)
{
        int i;
        ...
        for (i = 0; builtins_v_env[i] != NULL; i++) {
                if ((str_cmp(cmd[0], builtins_v_env[i])) == 0) {
